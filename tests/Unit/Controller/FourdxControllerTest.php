...
final class FourdxControllerTest extends BaseTestCase
{
    /**
     * @return \Mockery\MockInterface|\Mockery\LegacyMockInterface|FourdxController
     */
    protected function createTargetMock()
    {
        return Mockery::mock(FourdxController::class);
    }
    ...
    public function testExecuteIndex()
    {
        ...
        $targetMock
            ...
            ->once()
            ->with($responseMock, '4dx/index.html.twig', $data)
    ...
    public function testExecuteAbout()
    {
        ...
        $targetMock
            ->shouldReceive('render')
            ->once()
            ->with($responseMock, '4dx/about.html.twig')
            ->andReturn($responseMock);
    ...
    public function testExecuteScheduleList()
    {
        ...
        $targetMock
            ->shouldReceive('render')
            ->once()
            ->with($responseMock, '4dx/schedule/list.html.twig', $data)
            ->andReturn($responseMock);
    ...
    public function testExecuteScheduleShow()
    {
        ...
        $targetMock
            ->shouldReceive('render')
            ->once()
            ->with($responseMock, '4dx/schedule/show.html.twig', $data)
            ->andReturn($responseMock);
    ...
    public function testExecuteNewsList()
    {
        ...
        $targetMock
            ->shouldReceive('render')
            ->once()
            ->with($responseMock, '4dx/news/list.html.twig', $data)
            ->andReturn($responseMock);
    ...
    public function testExecuteNewsShow()
    {
        ...
        $targetMock
            ->shouldReceive('render')
            ->once()
            ->with($responseMock, '4dx/news/show.html.twig', $data)
            ->andReturn($responseMock);
    ...
    public function testExecuteTheater()
    {
        ...
        $targetMock
            ->shouldReceive('render')
            ->once()
            ->with($responseMock, '4dx/theater.html.twig', $data)
            ->andReturn($responseMock);
