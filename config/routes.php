...
$app->group('/theater/{name}', function () {
    ...
    $this->get('/advance-tickets', TheaterController::class . ':advanceTicket')->setName('theater_advance_ticket');
...
$app->group('/4dx', function() {
    ...
    $this->get('/news/list', FourdxController::class . ':newsList')->setName('4dx_news_list');
    $this->get('/news/{id}', FourdxController::class . ':newsShow')->setName('4dx_news_show');
