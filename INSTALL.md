...
|APPSETTING_MEMBERSHIP_AUTHORIZATION_HOST|*String*|○|会員認可サービス ホスト|
|APPSETTING_MEMBERSHIP_AUTHORIZATION_CLIENT_ID|*String*|○|会員認可サービス Client ID|
|APPSETTING_MEMBERSHIP_AUTHORIZATION_CLIENT_SECRET|*String*|○|会員認可サービス Client Secret|
